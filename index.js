    ...
    <div class="cabinet-corkboard">
        ...
        <div class="cabinet-research-section">
            <div class="cabinet-section-header">
                ...
                <div class="cabinet-slots-counter">// <span class="filled" id="cabinet-research-count">0</span>/3 SLOTS</div>
            </div>
            <div class="cabinet-card-stack" id="cabinet-research-stack">
                <div class="cabinet-cascade-card empty-slot" data-slot="1">
                    <div class="cabinet-empty-slot-text">Empty slot...</div>
                </div>
                <div class="cabinet-cascade-card empty-slot" data-slot="2">
                    <div class="cabinet-empty-slot-text">Empty slot...</div>
                </div>
                <div class="cabinet-cascade-card empty-slot" data-slot="3">
                    <div class="cabinet-empty-slot-text">Empty slot...</div>
                </div>
            </div>
        </div>
        ...
        <div class="cabinet-generate-section">
            <div class="cabinet-legal-pad">
                ...
                <div class="cabinet-from-chat-toggle">
                    <input type="checkbox" id="cabinet-from-chat">
                    <label for="cabinet-from-chat">From chat</label>
                </div>
                
                <div class="cabinet-perspective-toggle">
                    <button class="cabinet-perspective-btn" data-perspective="observer">🔎 Observer</button>
                    <button class="cabinet-perspective-btn active" data-perspective="participant">🎭 Participant</button>
                </div>
                
                <input type="text" class="cabinet-legal-input" id="cabinet-identity-input" placeholder="Who are you? (e.g., 'a survivor who escaped')">
                
                <textarea class="cabinet-legal-textarea" id="cabinet-concept-input" placeholder="Enter a concept, obsession, or idea to mull over..."></textarea>
