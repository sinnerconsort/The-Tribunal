            ...
            <div class="radio-body">
                ...
                <div class="radio-station-panel" id="ie-station-list">
                    <div class="radio-station-item" data-station="0">
                        ...
                        <span class="station-name">STATIC</span>
                        <span class="station-type">AMBIENT</span>
                    </div>
                    <div class="radio-station-item active" data-station="1">
                        <span class="station-freq">92.3</span>
                        <span class="station-name">SPEEDFREAKS</span>
                        <span class="station-type">MUSIC</span>
                    </div>
                    <div class="radio-station-item" data-station="2">
                        <span class="station-freq">98.3</span>
                        <span class="station-name">WHIRLING</span>
                        <span class="station-type">AMBIENT</span>
                    </div>
                    <div class="radio-station-item" data-station="3">
                        <span class="station-freq">103.7</span>
                        <span class="station-name">REVACHOL</span>
                        <span class="station-type">MUSIC</span>
                    </div>
                    <div class="radio-station-item" data-station="4">
                        <span class="station-freq">108.0</span>
                        <span class="station-name">DOLORES DEI</span>
                        <span class="station-type">AMBIENT</span>
                    </div>
                </div>
