...
<div class="ie-tab-content inventory-page" data-tab-content="inventory">
    ...
    <div class="inventory-subcontent inventory-subcontent-active inv-evidence-container" data-subcontent="inv">
        ...
        <div class="inv-evidence-table">
            ...
            <!-- Scanning Overlay (shown during AI scan) -->
            <div class="inv-scan-overlay" id="ie-scan-overlay" style="display: none;">
                <div class="inv-scan-overlay-text">
                    <span class="inv-scan-dot">●</span> SCANNING
                </div>
                <div class="inv-scan-overlay-sub" id="ie-scan-status">Analyzing context...</div>
            </div>
            ...
            <div class="inv-evidence-detail" id="ie-item-detail" style="display: none;">
                ...
                <button class="inv-evidence-refresh-btn" id="ie-refresh-btn" style="display: none;" title="Regenerate with current genre">
...
async function scanForInventory() {
    ...
    try {
        ...
        if (statusEl) statusEl.textContent = `Found ${items.length} items, generating...`;
        ...
        for (const item of items) {
            ...
            if (statusEl) statusEl.textContent = `Generating: ${name}...`;
