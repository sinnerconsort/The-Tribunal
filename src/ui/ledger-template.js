...
<div class="ie-tab-content ledger-page" data-tab-content="ledger">
    ...
    <div class="ledger-subtabs">
        ...
        <button class="ledger-subtab" data-ledger-tab="journal">JOURNAL</button>
    ...
    <!-- JOURNAL sub-content -->
    <div class="ledger-subcontent journal-page" data-ledger-content="journal">
        <!-- Stale indicator (shown when new events exist since last gen) -->
        <div class="journal-stale-banner" id="journal-stale-banner" style="display: none;">
            <i class="fa-solid fa-circle-exclamation"></i>
            <span id="journal-stale-text">New events since last entry</span>
        </div>
        
        <!-- Journal content area (filled by generation) -->
        <div class="journal-content" id="journal-content">
            <div class="journal-empty">
                <i class="fa-solid fa-book-open journal-empty-icon"></i>
                <p class="journal-empty-quote">No journal entries yet.</p>
                <p class="journal-empty-hint">Generate your first entry to see the story so far.</p>
            </div>
        </div>
        
        <!-- Generate button -->
        <div class="journal-controls">
            <button class="journal-generate-btn" id="journal-generate-btn" title="Generate journal entry">
