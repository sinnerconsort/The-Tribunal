...
export function populateSettingProfiles() {
    ...
    select.addEventListener('change', () => {
        ...
        settings.genreProfile = select.value; // Keep in sync for Profiles tab readers
        saveSettings();
        ...
        // Notify all genre-aware systems (CRT vitals, newspaper, investigation, etc.)
        window.dispatchEvent(new CustomEvent('tribunal:genreChanged', {
            detail: { profileId: select.value }
        }));
